...
if __name__ == '__main__':
    ...
    datasets = [
        ...
        # }
        {
            'data': loader.WiscosinBreastCancerData(verbose=verbose, seed=seed),
            'name': 'wiscosin_breast_cancer',
            'readable_name': 'Wiscosin Breast Cancer',
        },
        {
            'data': loader.CreditCardFraud(verbose=verbose, seed=seed),
            'name': 'credit_card_fraud',
            'readable_name': 'Credit Card Fraud',
        }
    ]
